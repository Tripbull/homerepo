...
<head>
	...
	<title>Tabluu's privacy page</title>
...
<?php require_once('header.html'); ?>
    <section class="section-privacy clear">
    	<div class="container">
			...
			<div class="wrapper_privacy_content">
			<p class="notdot">Your privacy is very important to us. Accordingly, we have developed this Policy in order for you to understand how we collect, use, communicate and disclose and make use of personal information. The following outlines our privacy policy.</p>
			...
			<p>We will only retain personal information as long as necessary for the fulfilment of those purposes.</p>
