...
class db{
	...
	public $xmluser = XML_USER; //username xml access user subscriptions to chargify.com
    ...
    public $freever = 3602345;//3356308;
	public $enterprise = 3602346; //3356316
	public $basicID=3356305; public $proID=3356306; public $proplusID =3356316;
    public $chargifydomain = 'tripbull';
	public $dbcon = false;
	public $path = '';//'../staging/';
